    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                <el-form-item :label="contents.inputTitle == 1 ? '个人账号' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.gerenzhanghao" placeholder="个人账号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.gerenzhanghao" placeholder="个人账号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.gerenzhanghao" placeholder="个人账号" clearable></el-input>
                </el-form-item>
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="手机号码">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="xiangpian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="相片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.xiangpian">
                        <img :src="$base.url+scope.row.xiangpian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.gerenzhanghao!='' && this.searchForm.gerenzhanghao!=undefined){
            params['gerenzhanghao'] = '%' + this.searchForm.gerenzhanghao + '%'
          }
