<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">宠物用品购物网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">个人账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gerenzhanghao" class="input" type="text" placeholder="个人账号">
			   </div>
			 </div> -->
			<el-form-item label="个人账号" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.gerenzhanghao" autocomplete="off" placeholder="个人账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.gerenzhanghao) && `yonghu` == this.tableName){
        this.$message.error(`个人账号不能为空`);
        return
      }
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20210422/c87659aa9579401da86d9274a7beac2a.jpg);
      ...
      box-sizing: border-box;
        ...
        .send-code {
          ...
          .register-code {
            ...
            border-radius: 0;
            background-color: rgba(171, 214, 229, 1);
            box-shadow: 0 0 6px rgba(255,0,0,0);
          }
        }
          ...
          border-color: #409EFF;
          border-radius: 4px;
          background-color: rgba(132, 217, 164, 1);
